...
import heroImage from '../assets/heroImage21.jpg';
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full pb-8'>
                <h1 className='text-3xl text-gray-500 py-4 max-w-md font-bold'>
                   <center>Hello, Bhavya Sharma Here!</center>
                </h1>
                <h2 className='text-4xl sm:text-7xl font-bold text-white'>
                    I'm a Data Analyst
                </h2>
                <h3 className='text-gray-500 py-4 max-w-md font-bold'>
                I am a Final Year Computer Science student at Vellore Institute of Technology,Bhopal. I'm very Passionate in learning new technology with having interest in Data Analytics and problem solving.
                <br/>
            ...
            <div>
                <br/>
                <br/>
                <img src={heroImage} width="25" height="25" alt="My profile" className='rounded-2xl mx-auto w-2/3 md:w-full'/>
            </div>
        </div>
    </div>
  )
